...
<body>
	<div class="main ui container masthead vertical segment">
		<div class="ui grid">
			<div class="column">
				<form class="ui form" action="${pageContext.request.contextPath }/link/update" method="post">
					<h2 class="ui header">Update Profile Link</h2>
						...
						<c:forEach var="item" items="${social }">
							<div class="field">
						      <div class="ui radio checkbox">
						        <input type="radio" name="icon" value="${item.icon }|${item.bg}" <c:if test="${fn:startsWith(form.icon,item.icon) }">checked</c:if> >
